...
user_defined_project_clone_depends="ssh://git@git.example.com/core/business-service-base.git"
user_defined_project_clone="ssh://git@git.example.com/core/business-service-core.git"
